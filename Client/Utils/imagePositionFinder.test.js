...
var imagePositionFinder_1 = require('./imagePositionFinder');
var consts = require('../model/consts');
class ImagePositionFinderTests extends tsUnit.TestClass {
    inLineShouldReturnCorrectResult() {
        var result = imagePositionFinder_1.ImagePositionFinder.inLine();
    ...
    generateBackgroundPositionsShouldReturnCorrectResult() {
        var result = imagePositionFinder_1.ImagePositionFinder.generateBackgroundPositions();
        this.areIdentical(4, result.length);
        this.areIdentical(15, result[0].length);
    }
}
exports.ImagePositionFinderTests = ImagePositionFinderTests;
//# sourceMappingURL=imagePositionFinder.test.js.map